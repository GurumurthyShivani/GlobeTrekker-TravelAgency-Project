  ...
  return (
    ...
    <div id='packages' className='w-full bg-gray-200  flex flex-col justify-center items-center gap-10 lg:px-22 px-5 lg:py-22 py-20'>
      ...
      <div id='top' className='w-full flex lg:flex-row flex-col justify-between items-center lg:gap-20 gap-5'>
          <div>
            <h1 data-aos="zoom-in" data-aos-delay="100" className='lg:text-5xl text-3xl font-semibold text-black'>Explore Our Most Popular Travel Packages</h1>
          </div>
          <div className='flex flex-col justify-between items-start gap-7'>
            <p  data-aos="zoom-in" data-aos-delay="200" className='text-gray-500 w-full text-left'>Choose from our most popular travel packages and enjoy unforgettable journeys filled with adventure, culture, and stunning destinations.</p>
            ...
            <div key={index} className='w-full flex flex-col justify-between items-start'>
              ...
              <div id='imagebox' style={{backgroundImage: `url(${item.image})`}} className='bg-cover bg-center h-[300px] w-full        rounded-t-md relative' >
                <span className='bg-orange-600 text-white absolute top-0 left-6 w-auto h-auto p-2 flex flex-col justify-center items-center rounded-md'>
                    <span className='text-xl font-medium'>{item.price}
                    </span>
              ...
              <div id='content-box' className='w-full flex flex-col justify-between items-start bg-white p-7 gap-5'>
                <h1 className='text-xl text-black font-semibold w-[80%]'>{item.name}</h1>
                <hr  className='w-full border-1 border-gray-100'/>
                <div className='w-full flex justify-start items-center gap-5'>
                  <span className='flex justify-between items-center gap-1'><MdOutlineDateRange className='text-orange-600 text-3xl'/><p className='text-xl'>{item.days} </p></span>
                  <span className='flex justify-between items-center gap-1'><FaUsers className='text-orange-600 text-3xl'/><p className='text-xl'>{item.pax} </p></span>
                </div>
